...
exports.updateCommentsCount = exports.updateLikesCount = void 0;
...
exports.updateLikesCount = functions.https.onRequest((request, response) => {
    ...
    admin.firestore().collection("posts").doc(postId).get().then((data) => {
        ...
        admin.firestore().collection("posts").doc(postId).update(updateData).then(() => __awaiter(void 0, void 0, void 0, function* () {
            if (action == "like") {
...
exports.updateCommentsCount = functions.firestore.document('comments/{commentId}').onCreate((event) => __awaiter(void 0, void 0, void 0, function* () {
    let data = event.data();
