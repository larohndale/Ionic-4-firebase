...
module.exports = "page-feed .rowStyle {\n  border: solid var(--ion-color-primary) 1px;\n  border-radius: 30px;\n  margin-top: 15px; }\n  page-feed .rowStyle ion-input {\n    margin-top: 5px; }\n  page-feed .bottom-bar {\n  background-color: var(--ion-color-primary); }\n  page-feed .bottom-bar .border-right {\n    border-right: 1px solid var(--ion-color-primary); }\n  page-feed .round-corners {\n  border-radius: 24px; }\n  .icon {\n  display: inline-block;\n  font-size: 20px;\n  color: #090909a5;\n  vertical-align: middle; }\n  .text {\n  display: inline-block;\n  vertical-align: middle; }\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
var FeedPage = /** @class */ (function () {
    ...
    FeedPage.prototype.loadMorePosts = function (event) {
        ...
        setTimeout(function () {
            ...
            firebase__WEBPACK_IMPORTED_MODULE_5__["firestore"]().collection("posts").orderBy("created", "desc").startAfter(_this.cursor).limit(_this.pageSize).get()
                .then(function (docs) {
                docs.forEach(function (doc) {
                    _this.posts.push(doc);
                });
    ...
    FeedPage.prototype.logout = function () {
        var _this = this;
        firebase__WEBPACK_IMPORTED_MODULE_5__["auth"]().signOut().then(function () { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    FeedPage.prototype.delete = function (post) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!(firebase__WEBPACK_IMPORTED_MODULE_5__["auth"]().currentUser.uid === post.data().owner)) return [3 /*break*/, 8];
    ...
    FeedPage = __decorate([
        ...
        __metadata("design:paramtypes", [_ionic_angular__WEBPACK_IMPORTED_MODULE_1__["NavController"], _ionic_angular__WEBPACK_IMPORTED_MODULE_1__["LoadingController"], _ionic_angular__WEBPACK_IMPORTED_MODULE_1__["ToastController"], _ionic_native_camera_ngx__WEBPACK_IMPORTED_MODULE_3__["Camera"], _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"], _angular_router__WEBPACK_IMPORTED_MODULE_8__["Router"], _services_services_service__WEBPACK_IMPORTED_MODULE_9__["ServicesService"], _ionic_angular__WEBPACK_IMPORTED_MODULE_1__["ActionSheetController"], _ionic_angular__WEBPACK_IMPORTED_MODULE_1__["AlertController"], _ionic_angular__WEBPACK_IMPORTED_MODULE_1__["ModalController"], _angular_fire_auth__WEBPACK_IMPORTED_MODULE_7__["AngularFireAuth"]])
    ], FeedPage);
    return FeedPage;
}());
